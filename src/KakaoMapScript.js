...
if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        var locPosition = new kakao.maps.LatLng(lat, lon), // 마커가 표시될 위치를 geolocation으로 얻어온 좌표로 생성합니다
            message = '<div style="padding:5px;">개인정보보호를 위해 출발깃발을 2분거리에 놓아주세요.</div>'; // 인포윈도우에 표시될 내용입니다
...
// 출발 마커가 표시될 위치입니다 
var startPosition = new kakao.maps.LatLng(37.453759680761, 	126.90326130724); 
...
// 도착 마커가 표시될 위치입니다 
var arrivePosition = new kakao.maps.LatLng(37.453655680761,126.90326130724);    
